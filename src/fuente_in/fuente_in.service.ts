...
export class FuenteDocsService {
  ...
  constructor(
    @InjectRepository(ConceptosEntity, 'operacion') private conceptosEntity: Repository<ConceptosEntity>,
    @InjectRepository(ConciliarComprasContEntity, 'operacion') private conciliarComprasContEntity: Repository<ConciliarComprasContEntity>,
    @InjectRepository(CuentasPorPagarEntity, 'operacion') private cuentasPorPagarEntity: Repository<CuentasPorPagarEntity>,
    @InjectRepository(NotaCComprasEntity, 'operacion') private notaCComprasEntity: Repository<NotaCComprasEntity>,
    @InjectRepository(NotaDComprasEntity, 'operacion') private notaDComprasEntity: Repository<NotaDComprasEntity>,
    @InjectRepository(OrdenPagoContEntity, 'operacion') private ordenPagoContEntity: Repository<OrdenPagoContEntity>,
    @InjectRepository(PagoDirectoContEntity, 'operacion') private pagoDirectoContEntity: Repository<PagoDirectoContEntity>,
    @InjectRepository(RCajaContEntity, 'operacion') private rCajaContEntity: Repository<RCajaContEntity>,
